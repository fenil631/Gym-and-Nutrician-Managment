...
<!DOCTYPE html>
 <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<!-- end:fh5co-header -->
		<div class="fh5co-parallax" style="background-image: url(images/two-men-in-gym-1490266112.jpg);" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-12 col-md-offset-0">
						<img class="img-responsive animate-box" src="images/25cc4ce7be87fe835e5a9db498308162.jpg" alt="About">
					</div>
